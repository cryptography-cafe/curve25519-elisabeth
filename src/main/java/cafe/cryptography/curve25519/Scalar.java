...
import static cafe.cryptography.curve25519.FieldElement.load_3;
...
public class Scalar {
    ...
    public static Scalar fromBytesModOrderWide(byte[] input) {
        ...
        long s2 = 0x1FFFFF & (load_3(input, 5) >> 2);
        long s3 = 0x1FFFFF & (load_4(input, 7) >> 7);
        long s4 = 0x1FFFFF & (load_4(input, 10) >> 4);
        long s5 = 0x1FFFFF & (load_3(input, 13) >> 1);
        long s6 = 0x1FFFFF & (load_4(input, 15) >> 6);
        long s7 = 0x1FFFFF & (load_3(input, 18) >> 3);
        long s8 = 0x1FFFFF & load_3(input, 21);
        long s9 = 0x1FFFFF & (load_4(input, 23) >> 5);
        long s10 = 0x1FFFFF & (load_3(input, 26) >> 2);
        long s11 = 0x1FFFFF & (load_4(input, 28) >> 7);
        long s12 = 0x1FFFFF & (load_4(input, 31) >> 4);
        long s13 = 0x1FFFFF & (load_3(input, 34) >> 1);
        long s14 = 0x1FFFFF & (load_4(input, 36) >> 6);
        long s15 = 0x1FFFFF & (load_3(input, 39) >> 3);
        long s16 = 0x1FFFFF & load_3(input, 42);
        long s17 = 0x1FFFFF & (load_4(input, 44) >> 5);
        long s18 = 0x1FFFFF & (load_3(input, 47) >> 2);
        long s19 = 0x1FFFFF & (load_4(input, 49) >> 7);
        long s20 = 0x1FFFFF & (load_4(input, 52) >> 4);
        long s21 = 0x1FFFFF & (load_3(input, 55) >> 1);
        long s22 = 0x1FFFFF & (load_4(input, 57) >> 6);
        long s23 = (load_4(input, 60) >> 3);
        long carry0;
        long carry1;
        long carry2;
        long carry3;
    ...
    public Scalar multiplyAndAdd(Scalar b, Scalar c) {
        ...
        long b0 = 0x1FFFFF & load_3(b.s, 0);
        long b1 = 0x1FFFFF & (load_4(b.s, 2) >> 5);
        long b2 = 0x1FFFFF & (load_3(b.s, 5) >> 2);
        long b3 = 0x1FFFFF & (load_4(b.s, 7) >> 7);
        long b4 = 0x1FFFFF & (load_4(b.s, 10) >> 4);
        long b5 = 0x1FFFFF & (load_3(b.s, 13) >> 1);
        long b6 = 0x1FFFFF & (load_4(b.s, 15) >> 6);
        long b7 = 0x1FFFFF & (load_3(b.s, 18) >> 3);
        long b8 = 0x1FFFFF & load_3(b.s, 21);
        long b9 = 0x1FFFFF & (load_4(b.s, 23) >> 5);
        long b10 = 0x1FFFFF & (load_3(b.s, 26) >> 2);
        long b11 = (load_4(b.s, 28) >> 7);
        long c0 = 0x1FFFFF & load_3(c.s, 0);
        long c1 = 0x1FFFFF & (load_4(c.s, 2) >> 5);
        long c2 = 0x1FFFFF & (load_3(c.s, 5) >> 2);
        long c3 = 0x1FFFFF & (load_4(c.s, 7) >> 7);
        long c4 = 0x1FFFFF & (load_4(c.s, 10) >> 4);
        long c5 = 0x1FFFFF & (load_3(c.s, 13) >> 1);
        long c6 = 0x1FFFFF & (load_4(c.s, 15) >> 6);
        long c7 = 0x1FFFFF & (load_3(c.s, 18) >> 3);
        long c8 = 0x1FFFFF & load_3(c.s, 21);
        long c9 = 0x1FFFFF & (load_4(c.s, 23) >> 5);
        long c10 = 0x1FFFFF & (load_3(c.s, 26) >> 2);
        long c11 = (load_4(c.s, 28) >> 7);
        long s0;
        long s1;
        long s2;
        long s3;
